...
mouths_final = cat_mouths * eigen_all_mouths;

%%%%%%%%%%%%%%%%%%%%%%%%%%    NOSE    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cat_noses = [cat_nose_1 ; cat_nose_2];
noses_final = cat_noses * eigen_all_noses;

%%%%%%%%%%%%%%%%%%%%%%%%%%    LEFT EYE    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cat_left_eyes = [cat_left_eye_1 ; cat_left_eye_2];
left_eyes_final = cat_left_eyes * eigen_all_left_eyes;

%%%%%%%%%%%%%%%%%%%%%%%%%%    RIGHT EYE    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cat_right_eyes = [cat_right_eye_1 ; cat_right_eye_2];
right_eyes_final = cat_right_eyes * eigen_all_right_eyes;

%%%%%%%%%%%%%%%%%%%%%%%%%%    LEFT CHEEK    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cat_left_cheeks = [cat_left_cheek_1 ; cat_left_cheek_2];
left_cheeks_final = cat_left_cheeks * eigen_all_left_cheeks;

%%%%%%%%%%%%%%%%%%%%%%%%%%    RIGHT CHEEK    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
cat_right_cheeks = [cat_right_cheek_1 ; cat_right_cheek_2];
right_cheeks_final = cat_right_cheeks * eigen_all_right_cheeks;


diff_mouths = sum((mouths_final(1,:) - mouths_final(2,:)).^2);
diff_noses = sum((noses_final(1,:) - noses_final(2,:)).^2);
diff_left_eyes = sum((left_eyes_final(1,:) - left_eyes_final(2,:)).^2);
diff_right_eyes = sum((right_eyes_final(1,:) - right_eyes_final(2,:)).^2);
diff_right_cheeks = sum((right_cheeks_final(1,:) - right_cheeks_final(2,:)).^2);
diff_left_cheeks = sum((left_cheeks_final(1,:) - left_cheeks_final(2,:)).^2);
